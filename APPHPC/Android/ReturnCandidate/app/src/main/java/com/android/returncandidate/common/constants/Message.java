...
public class Message {
     ...
     */
    public static final String MESSAGE_UPLPOAD_LOG_SCREEN = "ログファイルをアップロードしています。。。";
    ...
    public static final String MESSAGE_WAITING_FILTER = "選択集計中。。。";
    public static final String MESSAGE_WAITING_UPDATE = "選択設定中。。。";

    public static final String MESSAGE_CONFIRM_UNCHECK_GROUP_CD = "%sを外します。よろしいでしょうか？";
