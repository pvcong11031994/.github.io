...
(function(e) {
    ...
    e(document).mouseup(function() {
            ...
            e.position = {
                ...
                return _ = s(b), b[0].preventDefault && (n.at = "left top"), m = _.width, g = _.height, v = _.offset, y = e.extend({}, v), e.each(["my", "at"], function() {
                    ...
                    var s, l, u = e(this),
                        ...
                        S = c + _ + i(this, "marginBottom") + w.height,
                        M = e.extend({}, y),
        ...
        drag: function(t, i, s) {
            ...
            })), s.snapElements[c].snapping = !1) : ("inner" !== f.snapMode && (n = m >= Math.abs(u - _), a = m >= Math.abs(d - y), o = m >= Math.abs(h - v), r = m >= Math.abs(l - g), n && (i.position.top = s._convertPositionTo("relative", {
    ...
    e.extend(n.prototype, {
        ...
        _generateHTML: function(e) {
            var t, i, s, n, a, o, r, h, l, u, d, c, p, f, m, g, v, y, _, b, x, w, k, T, D, S, M, N, C, P, A, I, z, H, F, E, j, O, W, L = new Date,
        ...
        _createTitlebar: function() {
            var t;
            this.uiDialogTitlebar = e("<div>").addClass("ui-dialog-titlebar ui-widget-header-dialog ui-corner-all ui-helper-clearfix").prependTo(this.uiDialog), this._on(this.uiDialogTitlebar, {
                mousedown: function(t) {
