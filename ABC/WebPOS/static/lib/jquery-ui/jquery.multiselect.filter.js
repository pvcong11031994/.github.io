  ...
  $.widget('ech.multiselectfilter', {
    ...
    _create: function() {
      ...
      elem.bind('multiselectrefresh', $.proxy(function() {
        ...
        if(elem.attr("name") == "shop_cd") {
            this.wrapper = $("<div/>").addClass("ui-multiselect-filter ui-multiselect-shop-filter").text(opts.label).append(this.input).prependTo(this.header);
        }else{
