...
import com.android.productchange.common.utils.ProcessDialogSetting;
...
public class DFilterSettingFragment extends DialogFragment implements View.OnClickListener, AsyncResponse {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragement_setting_return_book, container, false);
    ...
    public void onResume() {
        ...
        ProcessDialogSetting processDialogSetting = new ProcessDialogSetting(getActivity(), getView());
        processDialogSetting.delegate = this;

        processDialogSetting.execute(arrFlagSettingNew);
    }
    ...
    private void submitFilter() {
        ...
        activity.onLitSelectedFilterSettingDialog(flagSettingNew, flagSettingOld, flagFilterSubmit);
    ...
    @Override
    public void processFinish(List<Returnbooks> output) {
        returnbooksList = output;
    }
}
