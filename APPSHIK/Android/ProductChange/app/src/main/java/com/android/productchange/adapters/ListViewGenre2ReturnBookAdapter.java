 ...
 * @since 2018-08-30.
 */
public class ListViewGenre2ReturnBookAdapter extends BaseAdapter {
     ...
     */
    public ListViewGenre2ReturnBookAdapter(Activity activity, ArrayList<HashMap<String, String>> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_genre2_return_book, null);
