...
public class DFilterListNumberOfStockFragment extends DialogFragment implements View.OnClickListener {

    /**
     * Interface to item selected to activity
     */
    public interface ItemSelectedNumberOfStocksDialogListener {

        /**
         * Function send list selected data to activity
         */
        void onLitSelectedNumberOfStocksDialog(FlagSettingNew flagSettingNew);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txvHeaderFilter.setText(Constants.HEADER_NUMBER_OF_STOCKS);
        ...
        loadListItemNumberOfStocks(flagSettingNew.getFlagNumberOfStocks());
        ...
        lsvList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                flagSettingNew.setFlagNumberOfStocks(list.get(position).get(Constants.SELECT_POISITION));
                flagSettingNew.setFlagNumberOfStocksShowScreen(list.get(position).get(Constants.SELECT_VALUE));
    ...
    /**
     * Get data filter number of stocks
     */
    private void loadListItemNumberOfStocks(String positionSelectNumberOfStocks) {

        //HashMap<String, String> hashMapAll = new HashMap<>();
        // position check month (1->100)
        ...
        // Load data from .xml
        final String arrReleaseDate[] = getResources().getStringArray(R.array.number_of_stocks);
        ...
        ListViewMonthReturnBookAdapter adapter = new ListViewMonthReturnBookAdapter(getActivity(), list, positionSelectNumberOfStocks);
