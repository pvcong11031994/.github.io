 ...
 * @since 2018-08-30.
 */
public class ListViewPublisherReturnBookAdapter extends BaseAdapter {
     ...
     */
    public ListViewPublisherReturnBookAdapter(Activity activity, ArrayList<HashMap<String, String>> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_publisher_return_book, null);
