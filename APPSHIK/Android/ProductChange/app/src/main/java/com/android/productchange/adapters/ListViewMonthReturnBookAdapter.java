 ...
 * @since 2018-08-30.
 */
public class ListViewMonthReturnBookAdapter extends BaseAdapter {
     ...
     */
    public ListViewMonthReturnBookAdapter(Activity activity, ArrayList<HashMap<String, String>> list, String positionSelect) {
