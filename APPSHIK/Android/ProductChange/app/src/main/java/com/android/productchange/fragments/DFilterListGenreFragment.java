...
import com.android.productchange.adapters.ListViewGenreReturnBookAdapter;
...
public class DFilterListGenreFragment extends DialogFragment implements View.OnClickListener {
     ...
     * Book model
     */
    private ReturnbookModel bookModel;
    ...
    private void loadListItemGroup1Cd() {
        ...
        ListViewGenreReturnBookAdapter adapter = new ListViewGenreReturnBookAdapter(getActivity(), list, flagSettingNew);
    ...
    private ArrayList<HashMap<String, String>> loadListItemGroup1CdReload() {
        ...
        // Adapter init
        // Set data adapter to list view
        ListViewGenreReturnBookAdapter adapter = new ListViewGenreReturnBookAdapter(getActivity(), listNew, flagSettingNew);
        lsvList.setAdapter(adapter);
        return listNew;
    }
