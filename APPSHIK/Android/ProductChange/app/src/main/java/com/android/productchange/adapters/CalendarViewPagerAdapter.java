...
import com.android.productchange.interfaces.OnDayViewClickListener;
import com.android.productchange.objects.CalendarDate;
import com.android.productchange.objects.CalendarMonth;
import com.android.productchange.views.CalendarDayView;
import com.android.productchange.views.CalendarMonthView;
...
public class CalendarViewPagerAdapter extends PagerAdapter implements OnDayViewClickListener {
    ...
    public CalendarViewPagerAdapter(List<CalendarMonth> list, ViewPager viewPager) {
        ...
        if (CustomCalendarView.flag) {
            mSelectedDate = new CalendarDate(CustomCalendarView.calendarDateFrom);
        } else {
            mSelectedDate = new CalendarDate(CustomCalendarView.calendarDateTo);
        }
