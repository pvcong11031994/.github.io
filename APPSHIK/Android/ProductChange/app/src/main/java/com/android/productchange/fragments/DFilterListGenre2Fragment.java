...
import com.android.productchange.adapters.ListViewGenre2ReturnBookAdapter;
...
public class DFilterListGenre2Fragment extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.layout_genre2_return_book, container, false);
    ...
    private void loadListItemGroup2Cd(String flagGroup1Cd, FlagSettingNew flagSettingNew) {
        ...
        ListViewGenre2ReturnBookAdapter adapter = new ListViewGenre2ReturnBookAdapter(getActivity(), list);
