...
public class Returnbooks implements Serializable {
     ...
     * Constructor Books
     */
    public Returnbooks(String jan_cd, int bqsc_stock_count, String bqgm_publisher_cd, String bqtse_last_supply_date,
     ...
     * Constructor Books
     */
    public Returnbooks(String jan_cd, Float percent_local, String flag_sales) {
