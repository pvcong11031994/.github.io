package com.android.productchange.views;
...
import com.android.productchange.adapters.CalendarViewPagerAdapter;
...
public class CustomCalendarView extends FrameLayout implements View.OnClickListener {
    ...
    public static Calendar calendarDateFrom, calendarDateTo;
    ...
    private void buildCalendarView() {
        ...
        if (flag) {
            today = new CalendarMonth(calendarDateFrom);
        } else {
            today = new CalendarMonth(calendarDateTo);
        }
            ...
            new ViewPager.OnPageChangeListener() {
                ...
                public void onPageScrollStateChanged(int state) {
                    ...
                    if (state == ViewPager.SCROLL_STATE_IDLE
                            && position == mViewPagerAdapter.getCount() - 2) {
                        addNext();
                    }
